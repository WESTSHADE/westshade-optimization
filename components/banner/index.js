                ...
                <Container maxWidth="md" classes={{root: styles["root-container"]}}>
                    {align === "left" ? (
                        <Grid container direction="column" justifyContent="center" alignItems="flex-start">
                            {title ? (<Typography variant="h6" classes={{h6: styles["typography-title"]}} paragraph={true} align="center"> {title} </Typography>) : null}
                            {content ? (<Typography variant="h3" classes={{h3: styles["typography-title"]}} align="center"> {content} </Typography>) : null}
                            {children}
                        </Grid>
                    ) : (
                        <Grid>
