                ...
                <Container maxWidth="lg">
                    <Grid container className={styles["top-container-text"]}>
                        ...
                        <p>
                            More ways to shop:&nbsp;
                            <Link
                                href="https://www.google.com/maps/place/Westshade+%7C+Custom+Printed+Canopy+Tents+%26+Umbrellas+Manufacturer/@33.6386335,-117.7365411,17z/data=!3m1!4b1!4m5!3m4!1s0x80dce985de651db3:0x2af0d918b783cbed!8m2!3d33.6386335!4d-117.7343524">
            ...
            <div className={styles["container"]}>
                <Container maxWidth="lg">
                    <Grid container>
                        ...
                        <Grid container item sm={12} md={3} justifyContent="center">
                            <List className={styles["container-list-horizon"]}>
                                <ListItem className={`${styles["container-listItem"]} ${styles["center"]} ${styles["text-bottom"]}`}
                                          component="a"
