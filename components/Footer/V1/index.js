    ...
    return (
        <footer style={{backgroundColor: "var(--secondary-background)"}}>
            ...
            <div className={clsx(["m-footer-wrap", "m-wrap-side"])}>
                <Block display="flex" flexDirection={["column", "column", "row-reverse"]} alignItems={[null, null, "center"]} justifyContent={["flex-start", "flex-start", "space-between"]} minHeight="86px"
