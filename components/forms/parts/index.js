    ...
    return(
        <Textarea
            ...
            overrides={{
                ...
                Input: { style: ($isFocused) => ({height: "180px", backgroundColor: backgroundColor? backgroundColor : "#ffffff", outline: "none", borderRadius: "4px", resize: "both", ":focus": {border: "1px solid #23A4AD"}})},
...
const CustomFileUploadInput = ({onChange, id, attachedFile}) => {
    ...
    return(
        <>
            ...
            >
                <i><svg xmlns="http://www.w3.org/2000/svg" width="21" height="16" viewBox="0 0 21 16" fill="none"><path d="M18.5 2H10.5L8.5 0H2.5C1.4 0 0.51 0.9 0.51 2L0.5 14C0.5 15.1 1.4 16 2.5 16H18.5C19.6 16 20.5 15.1 20.5 14V4C20.5 2.9 19.6 2 18.5 2ZM18.5 14H2.5V4H18.5V14ZM6.5 9.01L7.91 10.42L9.5 8.84V13H11.5V8.84L13.09 10.43L14.5 9.01L10.51 5L6.5 9.01Z" fill="#23A4AD"/></svg></i>
