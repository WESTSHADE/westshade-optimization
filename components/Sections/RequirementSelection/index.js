    ...
    return (
        <>
            <Block display="grid" gridTemplateColumns={["1fr", null, null, "repeat(2, 1fr)"]} gridTemplateRows={["repeat(2, max-content)", null, null, "1fr"]} height="100%" alignItems="flex-start">
                ...
                {/*Selection Section*/}
                <Block position="relative" height="100%" padding={["16px", null, null, "64px calc(50vw - " + (process.env.maxWidth / 2 - 20) + "px) 24px 20px"]}>
                    <Block maxWidth="355px" margin="auto" padding="6px"
                           $style={{
