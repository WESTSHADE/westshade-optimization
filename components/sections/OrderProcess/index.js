...
const OrderProcess = ({}) => {
    return (
        <Block width="100%" display="grid" gridTemplateColumns={["repeat(1, 1fr)", "repeat(2, 1fr)", "repeat(4, 1fr)"]} gridColumnGap={["16px", "16px", '100px']} gridRowGap={["26px", "18px", '40px']} justifyItems="center">
            <Sandwich src="/images/icon/icon-order-online.png" alt="Order Online" title="1. Order Online" content="Upload images and information and place an order online."
                      containerImageProps={{width: ["114px", "170px", "220px"]}} titleProps={{font: ["MinXLabel20", "MinXLabel24"]}}
            />
