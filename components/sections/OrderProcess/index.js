...
const OrderProcess = ({}) => {
    return (
        <Block width="100%" display="grid" gridTemplateColumns={["repeat(2, 1fr)", null, null, "repeat(4, 1fr)"]} gridColumnGap={["16px", null, null, '80px']} gridRowGap={["26px", "18px", '40px']} justifyItems="center">
            <Sandwich src="/images/icon/icon-order-online.png" alt="Order Online" title="1. Order Online" content="Upload images and information and place an order online."
                      containerImageProps={{width: ["114px", "170px"]}} titleProps={{font: ["MinXLabel20", "MinXLabel24"]}}
            />
