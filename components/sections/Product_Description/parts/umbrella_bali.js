...
const feature_1 = [{
    ...
    url: "images/product/umbrella/bali/feature-water.jpg",
    objectFit: "cover"

}, {
    tabTitle: "UV Protection",
    tabContent: "The fabric blocks 98% harmful UV rays.",
    url: "images/product/umbrella/bali/feature-uv.jpg",
    objectFit: "cover"
...
const feature_2 = [{
    ...
    url: "images/product/umbrella/bali/feature-frame.jpg",
    objectFit: "cover"
}, {
    ...
    url: "images/product/umbrella/bali/feature-crank-system.png",
    objectFit: "contain"
}]

const anatomyPart = [
    {url: "/part-hub.jpg", title: "HUB", content: "Strong lighting system embedded into the hub of the umbrella."},
    {url: "/part-crank.jpg", title: "CRANK", content: "Simple and easy to use crank lift system."},
    {url: "/part-tilt.jpg", title: "TILT", content: "Easy to use push button tilt for adjustable shading."},
];
        ...
        <Block display="grid" gridTemplateColumns="1fr" gridRowGap={["40px", "64px", "120px"]} paddingBottom={["40px", "64px", "120px"]}>
            <Block position="relative" backgroundColor="#F7F7F7" paddingTop={["36px", "42px", "54px"]} paddingBottom={["36px", "42px", "54px"]}>
                ...
                <Block position="relative" width={["282px", "440px", "566px"]} height={["282px", "440px", "566px"]} marginRight="auto" marginLeft="auto">
                    <Image src="images/product/umbrella/anatomy-bali.png" alt="anatomy bali frame" objectFit="contain" layout="fill"/>
                ...
                <Block width="100%" maxWidth="1152px" marginRight="auto" marginLeft="auto" display="grid" gridTemplateColumns="1fr" gridRowGap={["16px", "24px", "20px"]}>
                    <Block display="grid" gridTemplateColumns={["1fr", "1fr", "2fr 1fr"]} gridTemplateRows={["repeat(2, 220px)", "repeat(2, 286px)", "286px"]} gridRowGap={["16px", "24px", "20px"]} gridColumnGap="20px">
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/bali/versatile/umbrella-bali-1.jpg" alt="Versatile Umbrella Bali" layout="fill" objectFit="cover"/>
                        </Block>
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/bali/versatile/umbrella-bali-2.jpg" alt="Versatile Umbrella Bali" layout="fill" objectFit="cover"/>
                        </Block>
                    </Block>
                    <Block display="grid" gridTemplateColumns={["1fr", "1fr", "1fr 2fr"]} gridTemplateRows={["repeat(2, 220px)", "repeat(2, 286px)", "286px"]} gridRowGap={["16px", "24px", "20px"]} gridColumnGap="20px">
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/bali/versatile/umbrella-bali-3.jpg" alt="Versatile Umbrella Bali" layout="fill" objectFit="cover"/>
                        </Block>
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/bali/versatile/umbrella-bali-4.jpg" alt="Versatile Umbrella Bali" layout="fill" objectFit="cover"/>
                        </Block>
                    </Block>
                </Block>
            </Block>
