...
const feature_1 = [{
    ...
    url: "images/product/umbrella/catalina/feature-fabric.jpg",
    objectFit: "cover"
}, {
...
// },
    {
        ...
        url: "images/product/umbrella/catalina/feature-aluminum.jpg",
        objectFit: "cover"
    }]

const anatomyPart = [
    {url: "/part-fixings.jpg", title: "FIXINGS", content: "Our Marine grade stainless steel cables are strong and built to last, with toughness and characteristics."},
    {url: "/part-hub.jpg", title: "ALUMINUM HUB", content: "Our hubs are made with the strongest materials available. Stainless steel is constructed of marine grade aluminum creating a modern and streamlined umbrella."},
    {url: "/part-crank-lift.jpeg", title: "CRANK LIFT SYSTEM", content: 'A unique "rack and pinion" gear system. It easily opens and closes with a removable handle that prevents unauthorized access.'},
    {url: "/part-reinforced-channel.jpg", title: "REINFORCED CHANNEL", content: "Umbrella poles adapt to marine grade aluminum with powder coating. Its internal reinforcing channels are super strong to resist heavy wind."},
    {url: "/part-base-plate.jpg", title: "BASE PLATE", content: "Rugged cast alloy based plates adapt a marine grade aluminum with powder coating. It is a simple design without losing details."},
];
        ...
        <Block display="grid" gridTemplateColumns="1fr" gridRowGap={["40px", "64px", "120px"]} paddingBottom={["40px", "64px", "120px"]}>
            <Block position="relative" backgroundColor="#F7F7F7" paddingTop={["36px", "42px", "54px"]} paddingBottom={["36px", "42px", "54px"]}>
                ...
                <Block position="relative" width={["282px", "440px", "566px"]} height={["282px", "440px", "566px"]} marginRight="auto" marginLeft="auto">
                    <Image src="images/product/umbrella/anatomy-catalina.png" alt="anatomy catalina frame" objectFit="contain" layout="fill"/>
                ...
                <Block width="100%" maxWidth="1152px" marginRight="auto" marginLeft="auto" display="grid" gridTemplateColumns="1fr" gridRowGap={["16px", "24px", "20px"]}>
                    <Block display="grid" gridTemplateColumns="1fr" gridTemplateRows="286px" gridColumnGap="20px">
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/catalina/versatile/umbrella-catalina-1.jpg" alt="Versatile Umbrella Catalina" layout="fill" objectFit="cover"/>
                        </Block>
                    </Block>
                    <Block display="grid" gridTemplateColumns={["1fr", "1fr", "repeat(2, 1fr)"]} gridTemplateRows={["repeat(2, 220px)", "repeat(2, 286px)", "286px"]} gridRowGap={["16px", "24px", "20px"]} gridColumnGap="20px">
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/catalina/versatile/umbrella-catalina-2.jpg" alt="Versatile Umbrella Catalina" layout="fill" objectFit="cover"/>
                        </Block>
                        <Block position="relative" width="100%" height="100%" overflow="hidden" $style={{borderRadius: "8px"}}>
                            <Image src="images/product/umbrella/catalina/versatile/umbrella-catalina-3.jpg" alt="Versatile Umbrella Catalina" layout="fill" objectFit="cover"/>
                        </Block>
                    </Block>
                </Block>
            </Block>
