                    ...
                    <Panel title="Background">
                        ...
                        >
                            <Tab title="Color"
                                 artwork={() => (
                                     <Block position="relative" width="20px" height="20px">
                                         <Image src="/images/icon/icon_pantone.png" alt="pantone color" layout="responsive" width={60} height={60}/>
                                     </Block>
                                 )}
                                 overrides={{
                                     Tab: {
                            ...
                            <Tab title="Image"
                                 artwork={() => (
                                     <Block position="relative" width="20px" height="20px">
                                         <Image src="/images/icon/icon_picture.png" alt="picture" layout="responsive" width={60} height={60}/>
                                     </Block>
                                 )}
                                 overrides={{
                                     Tab: {
