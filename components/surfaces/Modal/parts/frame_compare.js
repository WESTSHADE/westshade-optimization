            ...
            >
                ...
                >
                    <Block font="MinXParagraph14">
                        ...
                        <Block className="cursor" marginTop="4px" color="#23A4AD" onClick={() => goSpecPage()}>Learn more</Block>
                    </Block>
                    <Block font="MinXParagraph14">
                ...
                <Block display="grid" gridTemplateColumns="repeat(3, 200px)" gridColumnGap="32px" width="fit-content" marginRight={["auto", "auto", "56px"]} marginLeft={["auto", "auto", "56px"]} paddingBottom="16px">
                    ...
                    <Block display="grid" gridTemplateColumns="1fr" gridRowGap="12px">
                        ...
                        <Block font="MinXLabel20">
                            <Block $style={{fontWeight: 600}}>5 years</Block>
                            <Block marginTop="4px" font="MinXParagraph14" color="MinXSecondaryText">Frame warranty</Block>
                        </Block>
                    </Block>
                    <Block display="grid" gridTemplateColumns="1fr" gridRowGap="12px">
                        ...
                        <Block font="MinXLabel20">
                            <Block $style={{fontWeight: 600}}>0.07&quot;</Block>
                            <Block marginTop="4px" font="MinXParagraph14" color="MinXSecondaryText">Pole thickness</Block>
                        </Block>
                        <Block font="MinXLabel20">
                            <Block $style={{fontWeight: 600}}>2.25&quot;</Block>
                            <Block marginTop="4px" font="MinXParagraph14" color="MinXSecondaryText">Pole diameter</Block>
                        </Block>
                        <Block font="MinXLabel20">
                            <Block $style={{fontWeight: 600}}>8</Block>
                            <Block marginTop="4px" font="MinXParagraph14" color="MinXSecondaryText">Size available</Block>
                        </Block>
                        <Block font="MinXLabel20">
                            <Block $style={{fontWeight: 600}}>10 years</Block>
                            <Block marginTop="4px" font="MinXParagraph14" color="MinXSecondaryText">Frame warranty</Block>
                        </Block>
                    </Block>
                </Block>
