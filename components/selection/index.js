    ...
    if (id === id_attribute_canopyColor || id === id_attribute_roofColor) {
        return (
            <Radio
                ...
                icon={
                    <div
                        className={styles["radio-color-dot"]}
            ...
            return (
                <Radio
                    ...
                    icon={
                        <img
                            className={styles["radio-image"]}
                            src={"/images/icon/" + value.substring(0, 2) + ".png"}
                        />
                    }
                    checkedIcon={
                        <>
            ...
            return (
                <Radio
                    ...
                    icon={
                        <img
                            className={styles["radio-image"]}
                            src={"/images/icon/" + stringFn.replaceSpace(value) + ".png"}
                        />
                    }
                    checkedIcon={
                        <>
        ...
        return (
            <Radio
                ...
                icon={
                    <img
                        className={styles["radio-image"]}
                        src={"/images/icon/wall-" + value + ".png"}
                    />
                }
                checkedIcon={
                    <>
            ...
            return (
                <Radio
                    ...
                    icon={
                        <img
                            className={styles["radio-image"]}
                            src={"/images/icon/" + value + "-tent.png"}
                        />
                    }
                    checkedIcon={
                        <>
