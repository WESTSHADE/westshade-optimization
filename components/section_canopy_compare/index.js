...
export default function Section_Canopy_Compare() {
	...
	return (
		<Box className="section-container" style={{ textAlign: "center" }}>
			...
			<Link href="/compare">
				<p className="section-content-entend">Compare all pop up canopy series &gt;</p>
			</Link>
				...
				<Grid container spacing={2}>
					<Grid item xs={12} sm={4}>
						<div className={`${styles["section-grid-item"]}`}>
							<div>
								<img className={`${styles["section-image"]}`} src="/images/y5-1@1x.png" />
							...
							<div>
								<Button variant="contained" className={`${styles["section-grid-button"]}`} onClick={() => router.push({ pathname: "/y5-economic/buy" })}>
									Buy
								</Button>
					...
					<Grid item xs={12} sm={4}>
						<div className={`${styles["section-grid-item"]}`}>
							<div>
								<img className={`${styles["section-image"]}`} src="/images/y6@2x.png" />
							...
							<div>
								<Button variant="contained" className={`${styles["section-grid-button"]}`} onClick={() => router.push("/y6-commercial/buy/")}>
									Buy
								</Button>
								<p className="section-content">
					...
					<Grid item xs={12} sm={4}>
						<div className={`${styles["section-grid-item"]}`}>
							<div>
								<img className={`${styles["section-image"]}`} src="/images/y7@1x.png" />
							...
							<div>
								<Button variant="contained" className={`${styles["section-grid-button"]}`} onClick={() => router.push("/y7-heavy-duty/buy/")}>
									Buy
								</Button>
								<p className="section-content">
