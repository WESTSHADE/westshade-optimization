...
import {Badge, Box, Button, Container, Grid, Link, List, ListItem, ListItemText, Typography, Hidden} from "@material-ui/core";
                ...
                >
                    ...
                    <div className="top-right">
                        ...
                        <div className="header-widge tools-element">
                            <Button
                                // href="https://www.westshade.com/my-account"
                                href="/my-account"
                                disableRipple>
            ...
            >
                <div className="main-left">
                    <div className="widget-wrap">
                        <Button
                            startIcon={
                                <img src="/images/icon/logo_dark.png" height={36} width={36}/>
                            }
                            href="/"
                            disableRipple
                        >
                                ...
                                <DropMenu
                                    ...
                                    menuList={[
                                        {label: "MARKET UMBRELLA"},
                                        {
                                            label: "Marco",
                                            type: "link",
                                            url: "/products/market-umbrellas/marco-umbrella",
                                        },
                                        {
                                            label: "Santorini Aluminum",
                                            type: "link",
                                            url: "/products/market-umbrellas/santorini-aluminum-umbrella",
                                        },
                                        {
                                            label: "Santorini Fiberglass",
                                            type: "link",
                                            url: "/products/market-umbrellas/santorini-fiberglass-umbrella",
                                        },
                                    ]}
                                    buttonGroup={
                                        <Box className="menu-item-grid-item-buttom-group h-unset">
                                ...
                                <DropMenu
                                    ...
                                    menuList={[
                                        {label: "TILT UMBRELLA"},
                                        {
                                            label: "Bail",
                                            type: "link",
                                            url: "/products/tilt-umbrellas/bali-crank-lift-patio-umbrella",
                                        },
                                    ]}
                                    buttonGroup={
                                        <Box className="menu-item-grid-item-buttom-group h-unset">
                                ...
                                <DropMenu
                                    ...
                                    menuList={[
                                        {label: "CANTILEVER UMBRELLA"},
                                        {
                                            label: "Catalina",
                                            type: "link",
                                            url: "/products/cantilever-umbrellas/catalina-umbrella",
                                        },
                                    ]}
                                    buttonGroup={
                                        <Box className="menu-item-grid-item-buttom-group h-unset">
                                ...
                                <DropMenu
                                    ...
                                    menuList={[
                                        {label: "INFLATABLE CANOPY"},
                                        {
                                            ...
                                            type: "link",
                                            url: "/products/inflatable-canopy-tent/basic-inflatable-canopy-tent",
                                        },
                                        {
                                            label: "Plus Inflatable Canopy Tent",
                                            type: "link",
                                            url: "/products/inflatable-canopy-tent/plus-inflatable-canopy-tent",
                                        },
                                        {
                                            label: "Extended Inflatable Canopy Tent",
                                            type: "link",
                                            url: "/products/inflatable-canopy-tent/extended-inflatable-canopy-tent",
                                        },
                                        {
                                            label: "Hexagon Inflatable Canopy Tent",
                                            type: "link",
                                            url: "/products/inflatable-canopy-tent/hexagon-inflatable-canopy-tent",
                                        },
                                        {
                                            label: "Triangular Inflatable Canopy Tent",
                                            type: "link",
                                            url: "/products/inflatable-canopy-tent/triangular-inflatable-canopy-tent",
                                        },
                                        {
                                            label: "Star Inflatable Canopy Tent",
                                            type: "link",
                                            url: "/products/inflatable-canopy-tent/star-inflatable-canopy-tent",
                                        },
                                    ]}
                                />
                            </li>
                ...
                <div className="main-right">
                    <Button
                        classes={{
                            root: styles["menuButton_right"],
                            label: styles["menuButton_right_label"],
                            endIcon: styles["menuButton_right_end"]
                        }}
                        endIcon={
