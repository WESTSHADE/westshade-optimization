		...
		return (
			<div className={styles["container"]}>
				...
				<Paper classes={{ root: styles["root-item-umbrella"] }} style={{ backgroundColor: backgroundColor, borderTopLeftRadius: tag ? 0 : "" }} elevation={0}>
					...
					<div className={styles["lower-section"]} style={{ backgroundColor: imageBackgroundColor }}>
						<div className={styles["card-description"]} style={{ backgroundColor: descBackgroundColor }}>
							{description}
						</div>
						<div className={styles["card-price"]}>
							<Grid container direction="row" alignItems="center" justifyContent="space-between">
								...
								<CLink backgroundColor={"black"} href={href} size="large">
									Shop
								</CLink>
							</Grid>
						</div>
