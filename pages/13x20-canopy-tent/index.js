      ...
      <Box className="section-navbar-container section-container-breadcrumb">
        <Container maxWidth="md">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">13x20 Canopy Tent</Typography>
          </Breadcrumbs>
        </Container>
      </Box>
      <Box className="section-container" style={{ marginTop: "0" }}>
        <Container maxWidth="sm">
          <h1 className="section-title">13x20 Canopy Tent</h1>
          <p className="section-content-entend">
            Westshade&#39;s 13x20 instant canopy tent can accommodate large
            parties with up to 260 square feet of shade and UV protection!
            Furthermore, this 13x20 canopy tent only comes in our most durable
            heavy duty aluminum frame - the Y7 series. You won&#39;t regret
            getting this large canopy tent for your events! This canopy tent is
            perfect for trade shows, parties, outdoor sports, commercial events,
            and more occasions.
            <br />
            <br />
            Browse our selection of 13x20 canopy tent series available, or
            customize your canopy tent with our custom printing packages to make
            it your own!
          </p>
        </Container>
      </Box>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <div className="section-image-container">
                <img className="section-image" src="/rectangle-42-4@2x.png" />
              </div>
            </Grid>
            <Grid item xs={12} md={6} container alignItems="center">
              <div className="container-grid-y7">
                ...
                <div style={{ margin: "18px auto" }}>
                  ...
                  <p className="section-title">$1,121.00</p>
                  <Button
                    variant="contained"
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6} container alignItems="center">
              <div className="container-grid-y7">
                ...
                <div style={{ margin: "18px auto" }}>
                  <p className="section-title">Starting at $1,857.00</p>
                  <Button
                    variant="contained"
                    className="section-grid-button"
          ...
          <Grid container>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-49-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-50-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-57-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-52-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-53-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-54-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-55-3@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-56-3@2x.png" />
                </div>
              </div>
            </Grid>
          </Grid>
