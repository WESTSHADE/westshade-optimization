        ...
        <React.Fragment>
            ...
            >
                <Block display="flex" flex={1} flexDirection="column" alignItems="center" marginBottom={["40px", "70px", "100px"]} paddingTop={["70px", "70px", "140px"]}>
                    <Block display="flex" flexDirection={["column", "column", "row-reverse"]} alignItems="center" justifyContent='space-between' width="100%">
                        ...
                        <Block display="flex" flexDirection="column" alignSelf={["flex-start", "flex-start", "center"]}>
                            ...
                            <MButton font={["MinXLabel14", "MinXLabel16"]} color="MinXPrimaryTextAlt" buttonBackgroundColor="#C8C9CC" text="Back to Homepage"
                                     startEnhancer={() => <ChevronLeft size={24}/>} onClick={() => router.push("/")}
                            />
                        </Block>
                    </Block>
                </Block>
