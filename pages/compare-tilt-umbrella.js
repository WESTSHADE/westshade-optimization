					...
					<>
						...
						<CContainer>
							<Container maxWidth="md">
								...
								<p className="section-content">Pick the perfect tilt umbrella for your shade</p>
								<Grid container spacing={2} justifyContent="space-evenly">
										...
										>
											<div>
												<div className="position-r">
													<img className="section-image" src="/images/rectangle-41-7@2x.png" />
												</div>
												<h3 className="section-title">Bali Umbrella</h3>
											</div>
											<div style={{ margin: "18px 0" }}>
												<p className="section-content">Starting at $289.99</p>
												<Button variant="contained" className="section-grid-button" onClick={() => router.push({ pathname: "/products/tilt-umbrellas/bali-crank-lift-patio-umbrella" })}>
													Buy
												</Button>
											</div>
										</div>
									...
									<Grid item xs={4}>
										...
										>
											<div>
												<div className="position-r">
													<img className="section-image" src="/images/rectangle-42-7@2x.png" />
												</div>
												<h3 className="section-title">Kapri Umbrella</h3>
											</div>
											<div style={{ margin: "18px 0" }}>
												<p className="section-content">Starting at $289.99</p>
												<Button variant="contained" className="section-grid-button" onClick={() => {}} disabled>
													Coming Soon
												</Button>
											</div>
										</div>
								...
								<Box className="section-container" style={{ textAlign: "center" }}>
									...
									<Grid container justifyContent="space-evenly">
										<Grid item xs={4}>
											<List>
												<ListItem className="section-canopy-tent-listItem">
													<ListItemText className="section-canopy-tent-listItem-content" secondary={"Octagon"} />
												</ListItem>
											</List>
										</Grid>
										<Grid item xs={4}>
								...
								<Box className="section-container" style={{ textAlign: "center" }}>
									...
									<Grid container justifyContent="space-evenly">
										<Grid item xs={4}>
											<List>
												<ListItem className="section-canopy-tent-listItem">
													<ListItemText className="section-canopy-tent-listItem-content" secondary={"Steel"} />
												</ListItem>
											</List>
										</Grid>
										<Grid item xs={4}>
											<List>
												<ListItem className="section-canopy-tent-listItem">
													<ListItemText className="section-canopy-tent-listItem-content" secondary={"Aluminum"} />
												</ListItem>
											</List>
										</Grid>
									</Grid>
									...
									<Grid container justifyContent="space-evenly">
										...
										<Grid item xs={4}>
											<List>
												...
												<ListItem className="section-canopy-tent-listItem">
													<ListItemText className="section-canopy-tent-listItem-content" primary={"Rib Diameter"} secondary={"8-rib construction, thickness 0.07”"} />
												</ListItem>
											</List>
										</Grid>
									</Grid>
								...
								<Box className="section-container" style={{ textAlign: "center" }}>
									...
									<Grid container justifyContent="space-evenly">
										<Grid item xs={4}>
											<List>
												<ListItem className="section-canopy-tent-listItem">
													<ListItemText className="section-canopy-tent-listItem-content" primary={"Pole Diameter"} secondary={"1.5”"} />
												</ListItem>
												<ListItem className="section-canopy-tent-listItem">
													<ListItemText className="section-canopy-tent-listItem-content" primary={"Rib Diameter"} secondary={"8-rib construction"} />
												</ListItem>
											</List>
										</Grid>
										<Grid item xs={4}>
