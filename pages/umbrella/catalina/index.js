    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                >
                    <div className="background-image">
                        <Image src="images/umbrella/catalina/fabric.png" alt="catalina fabric" layout="fill" objectFit="cover" quality={100}/>
                    </div>
            ...
            >
                ...
                <Block width="100%" maxWidth="960px" marginRight="auto" marginLeft="auto" display="grid" gridTemplateColumns={["repeat(2, 1fr)", "repeat(2, 1fr)", "repeat(3, 1fr)"]} gridColumnGap={["16px", "48px", "20px"]}
                       gridRowGap={["24px", "40px", "40px"]}>
            ...
            >
                ...
                <Block maxWidth="960px" width="100%" display="grid" gridTemplateColumns={["repeat(1, 1fr)", "repeat(1, 1fr)", "repeat(2, 1fr)"]} gridColumnGap="16px" gridRowGap="32px" marginRight="auto" marginLeft="auto">
                    ...
                    <Block display="flex" flexDirection="column" alignItems="center">
                        ...
                        <Block marginRight="auto" marginBottom="12px" marginLeft="auto" font="MinXLabel16" color="MinXPrimaryText">13’ Square</Block>
                        <MButton type="solid" height="40px" marginRight="auto" marginLeft="auto" font="MinXLabel16" text='Buy'
                                 buttonStyle={{paddingTop: "12px !important", paddingRight: "32px !important", paddingBottom: "12px !important", paddingLeft: "32px !important"}}
                    ...
                    <Block display="flex" flexDirection="column" alignItems="center">
                        ...
                        <Block marginRight="auto" marginBottom="12px" marginLeft="auto" font="MinXLabel16" color="MinXPrimaryText">16.4’ Square</Block>
                        <MButton type="solid" height="40px" marginRight="auto" marginLeft="auto" font="MinXLabel16" text='Buy'
                                 buttonStyle={{paddingTop: "12px !important", paddingRight: "32px !important", paddingBottom: "12px !important", paddingLeft: "32px !important"}}
