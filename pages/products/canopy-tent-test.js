...
function Canopy_Tent({ router, product, productComponent, productVariant }) {
	...
	const DataTable = () => {
				...
				<div style={{ textAlign: "right", fontSize: 14 }}>
					{onSale ? (
						<div style={{ display: "flex", flexDirection: "row" }}>
							{priceSale == 0 ? <div style={{ color: "#E4458C", marginRight: 10 }}>Free</div> : <NumberFormat thousandSeparator={true} prefix={"$"} value={priceSale} displayType={"text"} style={{ color: "#E4458C", marginRight: 10 }} />}
		...
		return (
			<div style={{ height: "100%" }}>
				...
				<div style={{ display: "flex", flexDirection: "row", padding: "12px 20px", borderTop: "1px solid #D9D9D9", justifyContent: "space-between", fontSize: 14, alignItems: "center" }}>
					<div>Total:</div>
	...
	return (
		<React.Fragment>
			{/* 主屏部分 */}
			<Block height={"100vh"} paddingTop={["48px", "48px", "96px"]} display={"flex"} justifyContent={"center"} overflow={["scroll", "scroll", "hidden"]} style={{ paddingTop: 146 }}>
				{/* 主要显示区域 */}
																	...
																	overrides={{
																		Label: ({ $value }) => (
																			<div style={{ position: "relative" }}>
																				...
																				<img style={{ height: 39, width: 39, objectFit: "contain", marginBottom: 27 }} src={"/images/icon/wall-" + option + ".png"} />
				...
				>
					<ModalBody className="modalSelectionContainer modalSelectionContainer-summary">
						...
						<Block width={["100%", "448px", "702px"]} height={"auto"} display={"flex"} flexDirection={["column", "column", "row"]} marginLeft={"auto"} marginRight={"auto"} paddingBottom={"16px"}>
