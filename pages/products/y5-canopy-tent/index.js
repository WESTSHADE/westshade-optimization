...
function TabPanel(props) {
  ...
  const setWallImage = () => {
    ...
    return "/product/" + handle + "/wall/Y5-" + url;
  };
...
export default function Y5_Buy() {
  ...
  const setFrameImage = (product) => {
    ...
    setImageFrame(
      "/product/" + product + "/frame/Y5-" + size + "-" + color + ".png"
    );
  };
      ...
      <Box className="section-navbar-container section-container-breadcrumb">
        <Container maxWidth="md">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">Y5 Economic Canopy Tent</Typography>
          </Breadcrumbs>
        </Container>
      </Box>
