        ...
        if (id === id_attribute_canopySize) {
            ...
            selection.forEach((item, indexA) => {
                ...
                item.forEach((attribute) => {
                    if (attribute.id === id_attribute_wallSize)
                        attribute.option =
                            (indexA - 1) % 2 === 0
                                ? sizes[0] + "ft"
                                : sizes[1] === "26"
    ...
    const checkProduct_getPrice = () => {
        ...
        selectedVariant.forEach((variant, index) => {
            if (
                ...
                productComponent[index].type !== "simple"
            ) {
            ...
            if (index === 0) {
                size = variant.attributes
                    .filter((attr) => attr.id === id_attribute_canopySize)[0]
                    .option.toUpperCase();
            } else {
                if (size === "13x26" && (index === 2 || index === 4)) {
                    if (!variant.on_sale) {
                        regularPrice +=
                            numberFn.strToFloat(variant.regular_price) * totalCount;
                        salePrice +=
                            numberFn.strToFloat(variant.regular_price) * totalCount;
                    } else {
                        regularPrice +=
        ...
        productComponent.map((component) => {
            ...
            if (component.id === id_product_wall) {
                defaultAttr.forEach((attr) =>
                    attr.id === id_attribute_wallType ? (attr.option = "none") : null
                );
            }
    ...
    useEffect(() => {
        ...
        selectedVariant.forEach((variant, index) => {
            ...
            let color = variant.attributes
                .filter((attr) => attr.id === id_attribute_canopyColor)[0]
                .option.toLowerCase();
            ...
            if (index === 0) {
                ...
                let type = variant.attributes
                    .filter((attr) => attr.id === id_attribute_wallType)[0]
                    .option.toLowerCase();
                const typeUrl = wallMap.get("type").find((w) => w.key === type).value;
                const sizeUrl = wallMap
                    .get("size")
                    .find((w) => w.key === size.toLowerCase()).value;
                const colorUrl = wallMap
                    .get("color")
                    .find((w) => w.key === color).value;
                                    ...
                                    <Grid item xs={12} sm={6} className="position-r">
                                        ...
                                        <div className={clsx(styles["container-product-section"], styles["b-b"])}>
                                            ...
                                            {product && product.short_description ? (
                                                <Typography variant="inherit" display="block" classes={{root: styles["product-description"]}}
                                                            color="textSecondary">
                                        ...
                                        <div>
                                                            ...
                                                            label={
                                                                <div>
                                                                    ...
                                                                    <Typography variant="inherit" display="block"
                                                                                classes={{root: styles["product-selection-subtitle"],}}>
                                            ...
                                            {productComponent && productComponent[0] ? (
                                                <div className={clsx(styles["container-product-section"], styles["b-b"])}>
                                                    ...
                                                    <Tabs classes={{root: styles["product-selection-wall-tabs"], indicator: styles["tabs-indicator"],}}
                                                        ...
                                                        return (
                                                            <div key={index} hidden={tab !== index}>
                                                                <Selections
                                                                    ...
                                                                    onChange={(event) =>
                                                                        handleChangeRadio(event, index + 1, id_attribute_wallType)
                                                                    }
                                                                ...
                                                                <Selections
                                                                    ...
                                                                    onChange={(event) =>
                                                                        handleChangeRadio(event, index + 1, id_attribute_canopyColor)
                                                                    }
                                                                    list={selectionColor}
                                        ...
                                        <Grid container direction="row" alignItems="center">
                                            <Typography variant="inherit"
                                                        classes={{root: clsx(styles["product-price"], totalSalePrice ? styles["discount"] : "")}}>
                                                    ...
                                                    {productId === "25649" ? (
                                                        ...
                                                        <Grid container spacing={6}>
                                                            ...
                                                            <Grid item xs={12} md={6} className={styles["container-content-ul"]}>
                                                                <Typography variant="h5" paragraph={true}> <strong> Y5 Economic Canopy </strong> </Typography>
                                                                <Typography component="span" classes={{root: styles["section-content"]}} color="textSecondary" display="block"
                                                                            align="left" paragraph={true}>
                                                                    Our Y5 economic canopy series is the best outdoor
                                                                    patio canopy for daily use.
                                                                    <br/>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            User-friendly design for 45 seconds setup with 2
                                                                            people.
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            Protective covers, tie down straps, and steel stakes
                                                                            with every purchase.
                                                                        </li>
                                                                        <li>
                                                                            Instant pop up with one release button for 3
                                                                            different heights adjustment from 5'2" to 6'8".
                                                                        </li>
                                                                        <li>
                                                                            Perfect for everyday use on your patio, garden, or
                                                                            deck.
                                                                        </li>
                                                        ...
                                                        <Grid container spacing={6}>
                                                            ...
                                                            <Grid item xs={12} md={6} className={styles["container-content-ul"]}>
                                                                <Typography variant="h5" paragraph={true}> <strong> Y6 Commercial Canopy </strong> </Typography>
                                                                <Typography component="span" classes={{root: styles["section-content"]}} color="textSecondary" display="block"
                                                                            align="left" paragraph={true}>
                                                                    Our Y6 commercial canopy series is the ultimate
                                                                    solution for small business and multi families.
                                                        ...
                                                        <Grid container spacing={6}>
                                                            ...
                                                            <Grid item xs={12} md={6} className={styles["container-content-ul"]}>
                                                                <Typography variant="h5" paragraph={true}> <strong> Y7 Heavy Duty </strong> </Typography>
                                                                <Typography component="span" classes={{root: styles["section-content"]}} color="textSecondary" display="block"
                                                                            align="left" paragraph={true}>
                                                                    Our Y7 heavy duty canopy series is the best
                                                                    heavy-duty canopy on the market. Unbeatable strength
                                                                    and durability while staying lightweight. Ideal
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Aerospace grade hexagonal aluminum frame.</li>
                                                                        <li>
                                                                            Thicker and lager pole compared to the other two
                                                                            series.
                                                                        </li>
                                                                        <li>
                                                                            Protective Covers, Tie Down Straps, and Steel Stakes
