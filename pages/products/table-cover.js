                                            ...
                                            <Typography variant="inherit" display="block" classes={{root: styles["product-description"]}} color="textSecondary">
                                                ...
                                                {productId === "57886" ? (
                                                    <>
                                                        <ul>
                                                            <li>
                                                                The Fitted Table Cover Range is constructed from the
                                                                same fabric as the instant canopy range.
                                                            </li>
                                                            <li>
                                                                The table cover features two zips at the back to assist
                                                                with fitting the cover and an access point to store
                                                        ...
                                                        <ul>
                                                            <li>
                                                                4FT Small: Length: 4’ (1230mm), Width: 2’ (620mm),
                                                                Height: 2’ 4” (720mm)
                                                            </li>
                                                            <li>
                                                                6FT Medium: Length: 6’ 1” (1840mm), Width: 2’ 6”
                                                                (770mm), Height: 2’ 4” (720mm)
                                                            </li>
                                                            <li>
                                                                8FT Large: Length: 8’ (2450mm), Width: 2’ 6” (770mm),
                                                                Height: 2’ 4” (720mm)
                                                            </li>
                                                        </ul>
                                                    </>
                                                    ...
                                                    <>
                                                        <ul>
                                                            <li>
                                                                The Stretch Table Cover range is firm fitting and is
                                                                constructed from a lightweight stretch fabric.
                                                            </li>
                                                            <li>
                                                                The cover stretches over the table and secures it’s self
                                                                with pockets at the base.
                                                            </li>
                                                        </ul>
                                                        Material
                                                        <ul>
