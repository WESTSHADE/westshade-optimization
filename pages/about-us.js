        ...
        <React.Fragment>
            ...
            <Block maxWidth="960px" marginRight="auto" marginLeft="auto">
                <Block display="flex" flexDirection="column" position="relative" alignItems="flex-start" justifyContent={"flex-end"} height={["181px", "272px", "517px"]}
                       marginRight="auto" marginBottom={["40px", "32px", "0px"]} marginLeft="auto" paddingRight={"30px"} paddingBottom={["38px", "30px", "140px"]}
                       paddingLeft={"30px"}
                >
                    <div className="background-image">
                        <Image src="images/about-us/about-us-display.png" alt="Umbrella" layout="fill" objectFit="cover" quality={100}/>
                    </div>
                    <div>
