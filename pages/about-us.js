        ...
        <React.Fragment>
            ...
            >
                <div>
                    ...
                    <Block maxWidth={["272px", "433px", "476px"]} font={["MinXTitle32", "MinXTitle44", "MinXTitle64"]} color="MinXPrimaryText">WE’VE GOT YOU COVERED</Block>
                </div>
                         ...
                         content={
                             <Block display="flex" flexDirection="column" paddingRight={[null, null, "78px"]} paddingLeft={[null, null, "78px"]}>
                                 ...
                                 <Block alignSelf={["flex-start", "flex-end"]} width={["100%", "390px", "587px"]} font="MinXParagraph14" color="MinXPrimaryText">
                                     Our goal is to bring <Block as="span" color="#23A4AD">comfort, quality, and convenience</Block> in enhancing our customers outdoor and indoor experience. In addition to our recreational and optimal
                                     business solution shelters, we also provide <Block as="span" color="#23A4AD">full custom-printing</Block> services in creating the ideal advertising method for your next product & service promotion!
                                 </Block>
                             </Block>
                         }
                />
