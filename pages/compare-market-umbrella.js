									...
									<Grid item xs={4}>
										...
										>
											...
											<div style={{ margin: "18px 0" }}>
												...
												<p className="section-content">Starting at $289.99</p>
												<Button variant="contained" className="section-grid-button" onClick={() => router.push({ pathname: "/products/market-umbrellas/santorini-aluminum-umbrella" })}>
													Buy
												</Button>
											</div>
										</div>
									...
									<Grid item xs={4}>
										...
										>
											...
											<div style={{ margin: "18px 0" }}>
												...
												<p className="section-content">Starting at $289.99</p>
												<Button variant="contained" className="section-grid-button" onClick={() => router.push({ pathname: "/products/market-umbrellas/santorini-fiberglass-umbrella" })}>
													Buy
												</Button>
											</div>
										</div>
