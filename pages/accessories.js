						...
						<CContainer>
							<Container maxWidth="sm">
								...
								<p className="section-content-entend">
									Westshade's selection of versatile accessories allows you to customize and combine individual elements depending on your personal or business needs. Add sidewalls to your instant pop-up canopy tent to protect you and your
									products from the weather, in addition to providing extra privacy. The side walls are attached to the canopy top with Velcro strips, and feature zips on either side to seamlessly connect the walls together.All sidewalls
									can be personalized with your logo or marketing messages to promote your products through our custom printing service. Learn more about custom printing and speak with our design specialists to get a quote on your order！
								</p>
							</Container>
										...
										<div className="section-grid-item">
											<div className="section-grid-item-inner" style={{ textAlign: "center" }}>
												...
												<div style={{ margin: "18px 0" }}>
													...
													<Button variant="contained" className="section-grid-button" onClick={() => router.push("/products/accessories?id=26516&type=half")}>
														Buy
													</Button>
												</div>
											</div>
										...
										<div className="section-grid-item">
											<div className="section-grid-item-inner" style={{ textAlign: "center" }}>
												...
												<div style={{ margin: "18px 0" }}>
													...
													<Button variant="contained" className="section-grid-button" onClick={() => router.push("/products/accessories?id=26516&type=rollup")}>
														Buy
													</Button>
												</div>
											</div>
										...
										<div className="section-grid-item">
											<div className="section-grid-item-inner" style={{ textAlign: "center" }}>
												...
												<div style={{ margin: "18px 0" }}>
													...
													<p className="section-content">From $115.00</p>
													<Button variant="contained" className="section-grid-button" onClick={() => router.push("/products/accessories?id=26516&type=pvc")}>
														Buy
													</Button>
												</div>
											</div>
										...
										<div className="section-grid-item">
											<div className="section-grid-item-inner" style={{ textAlign: "center" }}>
												...
												<div style={{ margin: "18px 0" }}>
													...
													<p className="section-content">From $115.00</p>
													<Button variant="contained" className="section-grid-button" onClick={() => router.push("/products/accessories?id=26516&type=mesh")}>
														Buy
													</Button>
												</div>
											</div>
                ...
                Shop canopy side walls &gt;
						...
						<CContainer>
							<Container maxWidth="sm">
								...
								<p className="section-content-entend">
									Add additional accessories to any of WESTSHADE's instant pop up canopy tent series to firmly secure your canopy. These are particularly helpful and can withstand adverse weather conditions. Accessories can also make
