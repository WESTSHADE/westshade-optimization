                        ...
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> Accessories </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            ...
                                                            src="/images/rectangle-86@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-2@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=26516&type=half")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-1@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            router.push(
                                                                "/products/accessories?id=26516&type=rollup"
                                                            )
                                                        }
                                                    >
                                                        Buy
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-3@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=26516&type=pvc")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-4@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=26516&type=mesh")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-7@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19296")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-8@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19254")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-9@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19212")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-10@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19927")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-11@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=41441")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-12@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19388")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-13@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19378")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-14@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19214")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-15@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19336")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-16@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=19256")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-5@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=20491")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                                                ...
                                                <div>
                                                    <div className="position-r">
                                                        <img
                                                            className="section-image"
                                                            style={{maxHeight: "250px"}}
                                                            src="/images/rectangle-86-6@2x.png"
                                                        />
                                                    </div>
                                                </div>
                                                <div style={{margin: "18px 0"}}>
                                                    ...
                                                    <Button
                                                        ...
                                                        className="section-grid-button"
                                                        onClick={() =>
                                                            router.push("/products/accessories?id=20510")
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
