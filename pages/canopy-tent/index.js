...
function Canopy_Tent({router}) {
    ...
    return (
        <React.Fragment>
            ...
            {/* 主要显示区域 */}
            <Block position="relative" alignItems="center" height={["480px", "660px", "900px"]} paddingTop={["60px", "80px", "160px"]} paddingRight="30px" paddingLeft="30px" backgroundColor="rgba(0, 0, 0, 0.2)"
                   overrides={{
                       Block: {
                           props: {
            ...
            >
                <Block position="absolute" width="100%" height="100%" top={0} right={0} bottom={0} left={0}
                       backgroundImage={"url(\"/images/canopy-tent/canopy-tent-display.jpg\")"} backgroundSize="cover" backgroundPosition="center" backgroundRepeat="no-repeat"
                       overrides={{
                           Block: {
                               style: {zIndex: "-1"}
                           },
