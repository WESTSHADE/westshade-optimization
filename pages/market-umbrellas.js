        ...
        <React.Fragment>
            <Head>
                ...
                <meta name="description"
                      content="Market Umbrella Shade Satisfaction All Day Recommended Santorini Fiberglass Series Heavy Duty Patio Umbrella. From$289.99 Shop Most Popular Santorini."/>
            </Head>
                            ...
                            <Container maxWidth="md">
                                <Grid container spacing={6} justifyContent="space-around" alignContent="center" alignItems="center">
                                    <Grid item xs={12} md={4}>
                                        <CUmbrella backgroundColor="#FDF0F0" descBackgroundColor="#C98F6F"
                                                   imageBackgroundColor="#EDD1D1"
                                                   src={"/images/rectangle-42@2x.png"}
                                                   tag="RECOMMENDED" title="Santorini" subtitle="Fiberglass series"
                                                   description="Heavy duty patio umbrella" price="289.99"
                                                   href={{pathname: "/products/market-umbrellas/santorini-fiberglass-umbrella",}}
                                        />
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <CUmbrella backgroundColor="#C9F5F5" descBackgroundColor="#19AEAC"
                                                   imageBackgroundColor="#94ECEC"
                                                   src={"/images/rectangle-41-2@2x.png"}
                                                   tag="MOST POPULAR" title="Santorini" subtitle="Aluminum series"
                                                   description="Commercial grade patio umbrella" price="289.99"
                                                   href={{pathname: "/products/market-umbrellas/santorini-aluminum-umbrella",}}
                                        />
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <CUmbrella backgroundColor="#FDEDCD" descBackgroundColor="#F6B93C"
                                                   imageBackgroundColor="#FCDC9C"
                                                   src={"/images/rectangle-40@2x.png"}
                                                   title="Macro"
                                                   description="Everyday use patio umbrella" price="289.99"
                            ...
                            <Container maxWidth="md">
                                ...
                                <Grid container spacing={6} justifyContent='space-around'>
                                    <Grid item xs={4}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> Push Up System </Typography>
                                        <Typography variant='body2' color="textSecondary" paragraph={true}>
                                            A push-open system works by simply pushing the umbrella upwards and open from the hub. Effortlessly open your umbrella in 15 seconds. NO
                                            extra
                                            tools required.
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={4}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> Pulley Lift System </Typography>
                                        <Typography variant='body2' color="textSecondary" paragraph={true}>
                                            Heavy duty double pulley system and commercial grade pulley rope help you to raise the umbrella in 15 second. More easily than push up
                                            system.
