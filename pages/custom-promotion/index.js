...
import Hero from "Components/Hero/CustomPromotion";
...
const Custom_Promotion = () => {
    ...
    return (
        <ThemeProvider.V2>
            <Block display="grid" gridTemplateColumns="100%" gridRowGap={["32px", null, "96px"]}>
                <Hero.V1 onClick={() => goToFreeMockup()}/>
...
export default Custom_Promotion;
