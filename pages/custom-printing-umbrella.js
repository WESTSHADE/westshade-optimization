        ...
        <React.Fragment>
            <Head>
                ...
                <meta name="description"
                      content="Custom Printing Umbrella Exquisite design yet strong and durable Custom Printing Umbrella Westshade provides a premium range of patio and market umbrellas."/>
            </Head>
            <Box className="page canopy-tent" fontSize={14} lineHeight={1.43}>
                {display ? (
                    <>
                        <Banner backgroundImage={"/images/banner/1920-610-19.jpeg"} title="Exquisite design yet strong and durable" content="Custom Printing Umbrella"
                                align="left"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        >
                                            ...
                                            <img
                                                ...
                                                src="/images/rectangle-87@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        >
                                            ...
                                            <img
                                                className="section-grid-custom-printing-umbrella-image"
                                                src="/images/rectangle-87-2@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        >
                                            ...
                                            <img
                                                className="section-grid-custom-printing-umbrella-image"
                                                src="/images/rectangle-87-1@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        >
                                            ...
                                            <img
                                                className="section-grid-custom-printing-umbrella-image"
                                                src="/images/rectangle-87-3@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                </Grid>
