...
export default function Y6_Overview() {
  ...
  const slideImages = [
    "/y6-canopy-roof-bk.png",
    "/y6-canopy-roof-bu.png",
    "/y6-canopy-roof-gn.png",
    "/y6-canopy-roof-rd.png",
    "/y6-canopy-roof-wh.png",
    "/y6-canopy-roof-ye.png",
  ];
    ...
    <div className="canopy-tent">
          ...
          <Grid container alignItems="center">
            ...
            <div className="section-navbar-item-group">
              <div className="section-navbar-item disable">
                <Link href="/y6-overview" disable>
                  Overview
                </Link>
              </div>
              <div className="section-navbar-item">
                <Link href="/y6-specs">Tech Specs</Link>
              </div>
              <Button
                variant="contained"
      ...
      >
        <div className="section-image-container">
          <img className="section-image" src="/y6-canopy-tent.png" />
        </div>
