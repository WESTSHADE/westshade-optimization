						...
						<CContainer>
							<Container maxWidth="md">
								...
								<Typography color="textSecondary" align="left" paragraph={true}>
									Protecting your private information is our priority. This statement of Privacy applies to westshade.com and WestShade and governs data collection and usage. For the purpose of this privacy policy, unless otherwise noted,
									all references to WestShade include westshade.com and Yimu International, Inc. The WestShade website is a online retail site. By using the WestShade website, you consent to the data practices described in this statement.
								</Typography>
								...
								<Typography color="textSecondary" align="left" paragraph={true}>
									...
									available on the Site. These may include: (a)registering for an account on our Site; (b)entering a sweepstakes or consent sponsored by us or one of our partners; (c)signing up for special offers from selected third
									parties; (d)sending us an email message; (e)submitting your credit card or other payment information when ordering and purchasing products and services on our Site. To wit, we will use your information for, but not limited
									to, communicating with you in relation to services and/or products you have requested from us. We also may gather additional personal or non-personal information in the future.
								</Typography>
								<Typography component="h6" align="left" paragraph={true}>
								...
								<Typography color="textSecondary" align="left" paragraph={true}>
									...
									<br />
									<br />
									WestShade may share with trusted partners to help perform statistical analysis, send you email or postal mail, provide customer support, or arrange for deliveries. All such third parties are prohibited from using your
									personal information except to provide these services to WestShade, and they are required to maintain the confidentiality of your information.
									<br />
									<br />
									WestShade may disclose your personal information, without notice, if required to do so by law or in the good faith belief that such action is necessary to: (a)conform to the edicts of the law or comply with legal process
									served on WestShade or the Site; (b)protect and defend the rights or property of WestShade; and/or (c)act under exigent circumstances to protect the personal safety of users of WestShade, or the public.
								</Typography>
								<Typography component="h6" align="left" paragraph={true}>
								...
								<Typography color="textSecondary" align="left" paragraph={true}>
									Information about your computer hardware and software may be automatically collected by WestShade. This information can include: your IP address, browser type, domain names, access times and referring website address. This
									information is used for the operation of the service, to maintain quality of the service, and to provide general statistics regarding use of the WestShade website.
								</Typography>
								<Typography component="h6" align="left" paragraph={true}>
								...
								<Typography color="textSecondary" align="left" paragraph={true}>
									...
									guaranteed to be 100% secure. As a result, while we strive to protect your personal information, you acknowledge that: (a) there are security and privacy limitation inherent to the Internet which are beyond our control;
								...
								<Typography component="span" classes={{ root: "gird-item-content" }} display="block" align="left" paragraph={true}>
									<ul>
										<li>
											Complete the transaction for which the personal information was collected, fulfill the terms of a written warranty pr product recall conducted in accordance with federal law, provide a good or service requested by you,
								...
								<Typography color="textSecondary" align="left" paragraph={true}>
									WestShade reserves the right to change this Privacy Policy from time to time. We will notify you about significant changes in the way we treat personal information by sending a notice to the primary email address specified
									in your account, by placing a prominent notice on our site, and/or by updating any privacy information on this page. Your continued use of the site and/or services available through this site after such modifications will
