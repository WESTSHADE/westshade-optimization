...
function Y5_Overview({ router }) {
	...
	const slideImages = ["/images/y5-canopy-roof-bk.png", "/images/y5-canopy-roof-bu.png", "/images/y5-canopy-roof-gn.png", "/images/y5-canopy-roof-rd.png", "/images/y5-canopy-roof-wh.png", "/images/y5-canopy-roof-ye.png"];
					...
					<>
						...
						<Box className="section-container-extend background-gray" style={{ marginTop: "0" }}>
							<Container maxWidth="sm">
								...
								<h3 className="section-title">The Best Outdoor Patio Canopy Perfect for Everyday Use.</h3>
								<p className="section-content">The perfect outdoor patio canopy for enjoying local scenery right at your feet! Furthermore, our steel made canopy comes with a weather resistant top covering for easy installation.</p>
						...
						<Box className="section-container" style={{ textAlign: "center" }}>
							<Container maxWidth="sm">
								<h3 className="section-title">Economical Steel Material Built for Excellent Performance.</h3>
								<p className="section-content-entend">
									We design our steel canopy frames to be resistant against rusts, stains, and mildews for better performance all year round. In addition, this is the
									<br />
									perfect friendly budget outdoor patio canopy for everyday usage at anytime.
								</p>
							</Container>
						</Box>
								...
								<Grid container spacing={2}>
									<Grid item xs={12}>
										<div className="section-grid-item" style={{ flexDirection: "row", alignItems: "center" }}>
											<div className="section-grid-item-inner">
												...
												<h3 className="section-title">One Button. No Hassle, Faster Set-up.</h3>
												<p className="section-content">
													With our thumb release button system, we make every steel canopy installment fast and smooth in just seconds! Secondly, the height can be easily adjusted to 3 different settings, from 5&#39;2&#34; to 6&#39;8&#34;
													at a remarkable speed.
												</p>
											</div>
											<img className="section-grid-image" style={{ padding: "0" }} src="/images/onepress@1x.png" />
										</div>
									</Grid>
									<Grid item xs={12} sm={6}>
										<div className="section-grid-item">
											...
											<img className="section-grid-image" src="/images/bracket-connector@1x.png" />
										</div>
									</Grid>
									<Grid item xs={12} sm={6}>
										<div className="section-grid-item ">
											...
											<img className="section-grid-image" src="/images/connecting-poles@1x.png" />
										</div>
									</Grid>
									<Grid item xs={12} sm={4}>
										<div className="section-grid-item">
											<div className="section-grid-item-inner">
												...
												<h3 className="section-title">Zinc coated nuts and bolts for easy replacement.</h3>
											</div>
											<img className="section-grid-image" src="/images/nuts-and-bolts@1x.png" />
										</div>
									</Grid>
									<Grid item xs={12} sm={4}>
										<div className="section-grid-item ">
									...
									<Grid item xs={12} sm={4}>
										<div className="section-grid-item ">
											<div className="section-grid-item-inner">
												...
												<h3 className="section-title">Zinc coated steel footpads. Guaranteed sturdy structure.</h3>
											</div>
											<img className="section-grid-image" src="/images/footpads@1x.png" />
										</div>
									</Grid>
								</Grid>
							</Container>
