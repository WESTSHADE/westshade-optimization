								...
								<div style={{ display: "flex", marginBottom: 24, marginRight: 24 }}>
									<div style={{ paddingRight: 24 }}>
										...
										<div className="account-tab">
											<Tabs orientation="vertical" variant="scrollable" value={3} onChange={(event, newValue) => changeRouter(newValue)} classes={{ indicator: "account-tab-indicator" }}>
								...
								<div style={{ marginBottom: 24, flex: 1 }}>
									{user ? (
										<div style={{ display: "flex", flexDirection: "column" }}>
											...
											<MXButton variant="contained" style={{ height: 48, backgroundColor: "#339059", color: "white", marginLeft: 0 }} onClick={fetchUpdateUser} disableElevation disableRipple>
												{"SAVE CHANGE"}
											</MXButton>
										</div>
									) : null}
