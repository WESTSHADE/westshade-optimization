                                                            ...
                                                            <Grid container spacing={2}>
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="billing-first-name" label="First name" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   onChange={(event) => {
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="billing-last-name" label="Last name" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   onChange={(event) => {
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="company-name" label="Company name (optional)" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }}
                                                                                   onChange={(event) => {
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="country" label="Country / Region" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   InputProps={{
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="street-address-1" label="Street address" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   onChange={(event) => {
                                                                    ...
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="street-address-2" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }}
                                                                                   onChange={(event) => {
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="town-city" label="Town / City" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   onChange={(event) => {
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="zip" label="ZIP" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   onChange={(event) => {
                                                                ...
                                                                <Grid item xs={12}>
                                                                    <div style={{margin: "24px auto 0"}}>
                                                                        <TextField id="email-address" label="Email address" variant="outlined" fullWidth
                                                                                   InputLabelProps={{
                                                                                       shrink: true,
                                                                                   }} required
                                                                                   onChange={(event) => {
