...
function Account(props) {
    ...
    const login = () => {
        fetchLogIn().then((data) => getUser()).catch((error) => null).finally(() => {
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <div style={{marginBottom: 24, flex: 1}}>
                                        <Typography variant="subtitle2" color="textSecondary" align="left">
                                            ...
                                            {/*(not {user ? user.username : ""}? Log out)*/}
                                            <br/><br/>
                                        ...
                                        <div style={{display: "flex", flexWrap: "wrap", margin: "24px auto"}}>
                                            <Button variant="outlined" classes={{root: 'root-account-Paper'}} onClick={() => router.push("/my-account/orders")} disableRipple>
                                                <Typography variant="subtitle1"><strong> Order </strong></Typography>
                                            </Button>
                                            <Button variant="outlined" classes={{root: 'root-account-Paper'}} onClick={() => router.push("/my-account/addresses")}
                                                    disableRipple>
                                                <Typography variant="subtitle1"><strong> Addresses </strong></Typography>
                                            </Button>
                                            <Button variant="outlined" classes={{root: 'root-account-Paper'}} onClick={() => router.push("/my-account/details")} disableRipple>
                                                <Typography variant="subtitle1"><strong> Account detail </strong></Typography>
                                            </Button>
                                            <Button variant="outlined" classes={{root: 'root-account-Paper'}} onClick={() => setTab(4)} disableRipple>
                                                <Typography variant="subtitle1"><strong> Logout </strong></Typography>
                                            </Button>
                                        </div>
                                    </div>
                                </Grid>
                                ...
                                <Grid container justifyContent="space-between" spacing={2}>
                                        ...
                                        {!showRegister ? (
                                            <>
                                                ...
                                                <form autoComplete="off">
                                                    <div style={{margin: "24px auto"}}>
                                                        <TextField id="username-email" label="Username or email" variant="outlined" fullWidth
                                                                   InputLabelProps={{
                                                                       shrink: true,
                                                                   }} required
                                                                   onChange={(event) => {
                                                ...
                                                <MXButton variant="contained" style={{height: 48, backgroundColor: "#339059", color: "white"}} onClick={login}
                                                          disableElevation
                                                          disableRipple
                                                          fullWidth>
                                                    {"LOG IN"}
                                            ...
                                            <>
                                                ...
                                                <div>
                                                    ...
                                                    <MXButton variant="contained" style={{height: 48, backgroundColor: "#339059", color: "white"}} onClick={fetchRegister}
                                                              disableElevation
                                                              disableRipple
                                                              fullWidth>
                                                        {"REGISTER"}
                                    ...
                                    <Grid item xs={12} md={5}>
                                        ...
                                        <Typography color="textSecondary" paragraph={true}>
                                            Registering for this site allows you to access your order status and history. Just fill in the fields below, and we'll get a new account
                                            set
                                            up
                                            for you in no time. We will only ask you for information necessary to make the purchase process faster and easier.
                                        </Typography>
