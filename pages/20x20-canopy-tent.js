...
function Canopy_Tent({router}) {
    ...
    const frame = [{
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y7", size: "20x20"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y7", size: "20x20"}}),
            ...
            <Block className="text-center" backgroundColor="#F7F7F7">
                <Block display="flex" flexDirection="column" marginBottom={["32px", "40px", "64px"]} padding={["24px 16px", "32px 16px", "40px 24px"]} backgroundColor="#F5FCFC">
                    ...
                    <Block width="100%" maxWidth="420px" marginRight="auto" marginLeft="auto" font="MinXLabel20">
                        ...
                        <Tabs activeKey={activeTabKey} fill={FILL.fixed} onChange={({activeKey}) => setActiveTabKey(activeKey + "")} renderAll
                              overrides={{
                ...
                <Block maxWidth="1152px" marginRight="auto" marginLeft="auto" paddingRight="16px" paddingBottom={["40px", "80px", "120px"]} paddingLeft="16px">
                    ...
                    <Block className="text-left" display="grid" gridGap="20px" gridTemplateColumns={["1fr", "1fr", "repeat(2, 1fr)"]}>
                        <Block className="section-round-corner-s" padding={["16px", "32px", "40px"]} backgroundColor="white">
                            <Block className="section-round-corner" position="relative" height={["190px", "307px", "353px"]} marginBottom={["16px", "24px", "32px"]}>
