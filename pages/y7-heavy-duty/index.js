...
function Y7_Overview({ router }) {
	...
	const slideImages = ["/images/y7-canopy-roof-bk.png", "/images/y7-canopy-roof-bu.png", "/images/y7-canopy-roof-gn.png", "/images/y7-canopy-roof-rd.png", "/images/y7-canopy-roof-wh.png", "/images/y7-canopy-roof-ye.png"];
					...
					<>
								...
								<Grid container alignItems="center">
									...
									<div className="section-navbar-item-group">
										<div className="section-navbar-item disable">
											<Link href="/y7-heavy-duty" disable>
												Overview
											</Link>
										</div>
										<div className="section-navbar-item">
											<Link href="/y7-heavy-duty/specs">Tech Specs</Link>
										</div>
										<Button variant="contained" className="section-navbar-item section-navbar-button" onClick={() => router.push("/y7-heavy-duty/buy/")}>
											Buy
										</Button>
									</div>
								</Grid>
						...
						<Box className="section-container-extend background-gray" style={{ marginTop: "0" }}>
							<div className="position-r">
								<img className="section-image" src="/images/y7-canopy-tent.png" />
							</div>
							<Container maxWidth="sm">
								<h1 className="section-subtitle" style={{ marginTop: "24px" }}>
									Y7 Heavy Duty Canopy Tent Aluminum Hex57
								</h1>
								<h3 className="section-title">Heavy duty canopy for business events, job fairs, and exhibitions.</h3>
								<p className="section-content">
									The most heavy duty canopy on the market with unchallenged strength and durability.
									<br />
									Aerospace-grade hexagonal aluminum frame. Super strong heavy duty lightweight canopy shelter.
									<br />
...
export default withRouter(Y7_Overview);
