...
function Y7_Overview({router}) {
    ...
    const slideImages = [
        "/images/y7-canopy-roof-bk.png",
        "/images/y7-canopy-roof-bu.png",
        "/images/y7-canopy-roof-gn.png",
        "/images/y7-canopy-roof-rd.png",
        "/images/y7-canopy-roof-wh.png",
        "/images/y7-canopy-roof-ye.png",
    ];
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <div className="section-grid-item">
                                            ...
                                            <img
                                                className="section-grid-image"
                                                src="/images/bracket-connector@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <div className="section-grid-item ">
                                            ...
                                            <img
                                                className="section-grid-image"
                                                src="/images/connecting-poles@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
                                        <div className="section-grid-item">
                                            ...
                                            <img
                                                className="section-grid-image"
                                                src="/images/nuts-and-bolts@2x.png"
                                            />
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
