...
import { Box, Button, Breadcrumbs, Container, Divider, Grid, Typography } from "@material-ui/core";

import CBreadcrumbs from "../../../components/breadcrumbs";

function Y7_Specs({ router }) {
							...
							<Grid container alignItems="center">
								...
								<div className="section-navbar-item-group">
									<div className="section-navbar-item ">
										<Link href="/y7-heavy-duty">Overview</Link>
									</div>
									<div className="section-navbar-item disable">
										<Link href="/y7-heavy-duty/specs" disable>
											Tech Specs
										</Link>
									</div>
					...
					<CBreadcrumbs>
						<Container maxWidth="md">
							<Breadcrumbs classes={{ li: "root-breadcrumbs-text" }}>
								...
								<Link color="inherit" href="/y7-heavy-duty" onClick={(event) => event.preventDefault()}>
									Y7 Heavy Duty
								</Link>
							...
							<Grid container spacing={2}>
								...
								<Grid item xs={12} sm={8}>
									...
									<div className="section-container-text">
										...
										<p className="section-content">4&#39; x 4&#39; zinc coated steel</p>
									</div>
								</Grid>
							</Grid>
							<Divider />
...
export default withRouter(Y7_Specs);
