        ...
        <React.Fragment>
            <Head>
                ...
                <meta name="description"
                      content="View WestShade's terms and conditions about agreement, privacy, communications, account, cancellation and refund policy, and disclaimers."/>
            </Head>
                        ...
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> Terms And Conditions </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Typography color="textSecondary" align="left" paragraph={true}>
                                    Visiting westshade.com or sending emails to WestShade constitutes
                                ...
                                <Typography color="textSecondary" align="left" paragraph={true}>
                                    ...
                                    from theft or misappropriation of your account. WestShade and its
                                ...
                                <Typography color="textSecondary" align="left" paragraph={true}>
                                    ...
                                    AND/OR ITS SUPPLIERS MAKE NO REPRESENTATION ABOUT THE
                                ...
                                <Typography color="textSecondary" align="left" paragraph={true}>
                                    ...
                                    between the user and WestShade with respect to the Site. Printed
