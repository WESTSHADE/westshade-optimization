                ...
                <Block width={["100%", "480px"]} display={"flex"} flexDirection={"column"}>
                    ...
                    <div className="container-selection"
                        ...
                        <div style={{fontSize: 14, lineHeight: "22px", marginBottom: 16, textAlign: "left"}}>
                            Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our <strong>privacy
                            policy</strong>
                        </div>
                        <Checkbox
                            checked={checked}
