...
function Canopy_Tent({router}) {
    ...
    const frame = [{
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y7", size: "16x16"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y7", size: "16x16"}}),
    ...
    return (
        <React.Fragment>
            <Head>
                <title>16x16 Canopy Tent | WESTSHADE</title>
            ...
            <Block backgroundColor="#F7F7F7" overrides={{Block: {props: {className: "text-center"}}}}>
                <Block display="flex" flexDirection="column" marginBottom={["32px", "40px", "64px"]} padding={["24px 16px", "32px 16px", "40px 24px"]} backgroundColor="#F5FCFC">
                    <Block marginBottom={["24px", "24px", "32px"]} font="MinXLabel32">16x16 Canopy Tent</Block>
