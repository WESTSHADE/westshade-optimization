...
function Canopy_Tent_Package({router}) {
    ...
    const handleSendQuote = async () => {
        if (!quoteSubject || !quoteNameLast || !quoteNameFirst || !quoteEmail || !quotePhone || !quoteRequest) {
            ...
            setShowModal(true);
            router.replace("/16x16-canopy-tent/#sent");
        }
    };
                        ...
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Typography color="textSecondary" paragraph={true}>
                                    Westshade&#39;s 16x16 instant pop up canopy tent provides maximum space to accommodate your business, and is perfect for any and all occasions! This spacious 16x16 canopy tent is can be moved whichever
                                    way you like due to
                                    its square dimensions, meaning that you don&#39;t have to distinguish between the front and back. This canopy tent only comes in our most durable heavy duty aluminum frame - the Y7 series. You won&#39;t
                                    regret getting this
                                    for your events!
                                    <br/>
                                    <br/>
                                    Browse our selection of 16x16 canopy tent series available, or customize your canopy tent to make it your own!
                                </Typography>
                            </Container>
                        </CContainer>
                        <CContainer>
                            <Container maxWidth="md">
                                <Grid container spacing={6}>
                                    <Grid item xs={12} md={6}>
                                        <MXImageDisplay src="/images/rectangle-42-1@2x.png" alt="y7-heavy-duty"/>
                                    </Grid>
                                    <Grid item xs={12} md={6} container alignItems="center">
                                        <div className="position-r">
                                            ...
                                            <MXContainerBuy text={"$1,769.00"} backgroundColor={"#2767c5"} dot href={{pathname: "/y7-heavy-duty/buy"}}/>
                                        </div>
                                    </Grid>
                                </Grid>
                            </Container>
                        ...
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} md={6}>
                                        <MXImageDisplay src="/images/rectangle-48@2x.png"/>
                                    </Grid>
                                    <Grid item xs={12} md={6} container alignContent="center">
                                        ...
                                        <Typography variant="h6" display="block" color="textPrimary" paragraph={true}>
                                            <strong>Starting at $2,656.00</strong>
                                        </Typography>
                                        <div style={{display: "flex", justifyContent: "flex-start"}}>
                                            <Button variant="contained" className="section-grid-button" style={{marginRight: "24px"}} onClick={() => router.push("/custom-printed-package/f1616cpp")} disableElevation>
                                                Buy
                                            </Button>
                                            <Button variant="contained" className="section-grid-button" style={{marginRight: "24px"}}
                                                    onClick={() => {
                                                        setQuoteSubject("Y7 Heavy Duty Custom Print 16x16");
                            ...
                            <Container maxWidth="md">
                                <Grid container spacing={2} direction="row" alignItems="center">
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP1.jpg" alt="custom-printing-16x16-package-1"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP2.jpg" alt="custom-printing-16x16-package-2"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP3.jpg" alt="custom-printing-16x16-package-3"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP4.jpg" alt="custom-printing-16x16-package-4"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP5.jpg" alt="custom-printing-16x16-package-5"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP6.jpg" alt="custom-printing-16x16-package-6"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP7.jpg" alt="custom-printing-16x16-package-7"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/16x16/Y7F1616CPP8.jpg" alt="custom-printing-16x16-package-8"/>
                                        </div>
                                    </Grid>
                                </Grid>
                            </Container>
