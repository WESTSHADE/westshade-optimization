        ...
        <React.Fragment>
            <Head>
                ...
                <meta name="description"
                      content="Tilt Umbrella Shade Satisfaction on Every Angle Most Popular Bali Every Day Use Tilt Umbrella From$289.99 Shop Kapri Coming soon From$289.99 Shop Free."/>
            </Head>
                            ...
                            <Container maxWidth="md">
                                <Grid container spacing={6} justifyContent="space-around" alignContent="center" alignItems="center">
                                    <Grid item xs={12} md={4}>
                                        <CUmbrella backgroundColor="#CAE3FA" descBackgroundColor="#4C8AC5"
                                                   imageBackgroundColor="#A6CBEB"
                                                   src={"/images/rectangle-41-7@2x.png"}
                                                   tag="MOST POPULAR" title="Bali" subtitle="Tilt umbrella"
                                                   description="Everyday use tilt umbrella" price="289.99"
                                                   href={{pathname: "/products/tilt-umbrellas/bali-crank-lift-patio-umbrella",}}
                                        />
                                    </Grid>
                                    <Grid item xs={12} md={4}>
                                        <CUmbrella backgroundColor="#E9DCCE" descBackgroundColor="#D8BF9A"
                                                   imageBackgroundColor="#E3D1BB"
                                                   src={"/images/rectangle-42-7@2x.png"}
                                                   title="Kapri"
                                                   description="Coming soon" price="289.99"
                            ...
                            <Container maxWidth="md">
                                ...
                                <Grid container spacing={6} justifyContent='space-around'>
                                    <Grid item xs={4}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> Crank Lift System </Typography>
                                    ...
                                    <Grid item xs={4}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> Auto Tilt System </Typography>
                                        <Typography variant='body2' color="textSecondary" paragraph={true}>
