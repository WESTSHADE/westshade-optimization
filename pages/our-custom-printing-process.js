									...
									<div>
										...
										<div style={{ textAlign: "left" }}>
											<Accordion expanded={expanded === "panel1"} onChange={handleChange("panel1")}>
												...
												<AccordionDetails>
													<Typography>We work where it’s easiest for you. After answering just a few quick questions, we can make sure your request is directed to the best person to help bring your project to life.</Typography>
												</AccordionDetails>
											</Accordion>
											...
											<Accordion square expanded={expanded === "panel3"} onChange={handleChange("panel3")}>
												...
												<AccordionDetails>
													<Typography>
														Once we figure out your product fit, our team of professional artists will craft a document to help you visually see what the finished product will look like at no cost. If you don’t like the first version, we’ll
											...
											<Accordion square expanded={expanded === "panel4"} onChange={handleChange("panel4")}>
												...
												<AccordionDetails>
													<Typography>All within 7-days your custom product is printed, cut, hand-sewn, assembled, quality checked and shipped out our door and on its way to you. That is all printing process. </Typography>
												</AccordionDetails>
											</Accordion>
										</div>
									</div>
									...
									<div>
										...
										<div style={{ textAlign: "left" }}>
											...
											<Accordion square expanded={expanded === "panel8"} onChange={handleChange("panel8")}>
												...
												<AccordionDetails>
													<Typography>A: No. In order to get products into our client’s hands quickly, we begin production as soon as you give us approval. There are no cancellations or returns on any custom-printed products.</Typography>
												</AccordionDetails>
											</Accordion>
										</div>
									</div>
