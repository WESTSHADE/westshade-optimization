...
function Canopy_Tent({router}) {
    ...
    const frame = [{
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y5", size: "10x15"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y5", size: "10x15"}}),
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y6", size: "10x15"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y6", size: "10x15"}}),
        onClickLink: () => setFrameCompareOpen(true)
    }, {
        tabTitle: "Y7",
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y7", size: "10x15"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y7", size: "10x15"}}),
        onClickLink: () => setFrameCompareOpen(true)
    }];
