...
function Canopy_Tent({router}) {
    ...
    const frame = [{
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y5", size: "10x10"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y5", size: "10x10"}}),
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y6", size: "10x10"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y6", size: "10x10"}}),
        onClickLink: () => setFrameCompareOpen(true)
    }, {
        tabTitle: "Y7",
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y7", size: "10x10"}}, {pathname: '/products/canopy-tent/buy', query: {series: "y7", size: "10x10"}}),
        onClickLink: () => setFrameCompareOpen(true)
    }];
    ...
    return (
        <React.Fragment>
            ...
            <Block className="text-center" backgroundColor="#F7F7F7">
                ...
                {activeTabKey === "0" ? (
                    <>
                        <Block maxWidth="1152px" margin="auto" padding={["0 16px 40px 16px", "0 16px 80px 16px", "0 16px 120px 16px"]}>
                            ...
                            <Button bundle="primary" width="97px" height="36px" marginRight="auto" marginBottom={["24px", "40px", "64px"]} marginLeft="auto" font="MinXParagraph14" text='Buy'
                                    onClick={() => goBuyingPage({pathname: '/products/canopy-tent', query: {series: "y5", size: "10x10"}}, {pathname: "/products/canopy-tent/buy", query: {series: "y5", size: "10x10"}})}
                            />
                            <AspectRatioBox aspectRatio={516 / 281} height={["159px", "260px", "494px"]}>
                                <AspectRatioBoxBody as={Image} src="/images/canopy-tent/tent/fabric-stock-color.webp" alt="fabric stock color" layout="fill" objectFit="contain" priority/>
                            </AspectRatioBox>
                            ...
                            >
                                ...
                                <Block display="grid" gridRowGap="12px" padding={["16px", "24px", "32px"]} overrides={{Block: {style: {textAlign: "left"}}}}>
                                    ...
                                    <Block font="MinXParagraph16" color="MinXSecondaryText">
                                        ...
                                        resistant, and it provides UV protection.
                                    </Block>
                                </Block>
                            </Block>
                        </Block>
