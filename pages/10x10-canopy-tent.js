                        ...
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> 10x10 Canopy Tent </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Typography color="textSecondary" paragraph={true}>
                                    The all original, classic 10x10 instant pop-up canopy suited for all
                                    professional events and recreational activities. With perfect
                                    symmetry and a complex truss bar connector design, our canopy
                                    shelter provides comfort and protection that fits all your basic
                                    outdoor and indoor needs. Choose between the Y5, Y6, and the Y7
                                    series available today for the right activity. In addition, we offer
                                    customizable custom printing packages to make your marketing and
                                    original display shine in front of your audience!
                                </Typography>
                            </Container>
                        </CContainer>
