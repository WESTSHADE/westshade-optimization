        ...
        <React.Fragment>
            <Head>
                ...
                <meta name="description"
                      content="View frequently asked questions about our shipping and return policies, estimated delivery, damaged items, and refunds."/>
            </Head>
                ...
                {display ? (
                    <>
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> Shipping </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                        ...
                        <CContainer>
                            <Container maxWidth="md">
                                <MXImageDisplay
                                    src="/images/fedex-ground-shipment.png"
                                    alt="fedex ground shipment"
                                />
                            </Container>
                        </CContainer>
                        <CContainer>
