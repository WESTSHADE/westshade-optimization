...
function Canopy_Tent({router}) {
    ...
    const frame = [{
        ...
        onClick: () => goBuyingPage({pathname: '/products/canopy-tent/buy', query: {series: "y7", size: "13x20"}}),
    ...
    return (
        <React.Fragment>
            <Head>
                <title>13x20 Canopy Tent | WESTSHADE</title>
                ...
                {displayTabs ? (
                    <>
                        <Block display="flex" flexDirection="column" marginBottom={["32px", "40px", "64px"]} padding={["24px 16px", "32px 16px", "40px 24px"]} backgroundColor="#F5FCFC">
                            <Block marginBottom={["24px", "24px", "32px"]} font="MinXLabel32">13x20 Canopy Tent</Block>
                                ...
                                <>
                                    <Block maxWidth="1152px" margin="auto" padding={["0 16px 40px 16px", "0 16px 80px 16px", "0 16px 120px 16px"]}>
                                        ...
                                        <Button width="97px" height="36px" marginRight="auto" marginBottom={["24px", "40px", "64px"]} marginLeft="auto" font="MinXParagraph14" text='Buy'
                                                onClick={() => goBuyingPage({pathname: '/products/canopy-tent/buy', query: {series: "y5", size: "13x20"}})}
                                        />
