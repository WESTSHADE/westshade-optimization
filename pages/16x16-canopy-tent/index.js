      ...
      <Box className="section-navbar-container section-container-breadcrumb">
        <Container maxWidth="md">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="textPrimary">16x16 Canopy Tent</Typography>
          </Breadcrumbs>
        </Container>
      </Box>
      <Box className="section-container" style={{ marginTop: "0" }}>
        <Container maxWidth="sm">
          <h1 className="section-title">16x16 Canopy Tent</h1>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <div className="section-image-container">
                <img className="section-image" src="/rectangle-42-1@2x.png" />
              </div>
            </Grid>
            <Grid item xs={12} md={6} container alignItems="center">
              <div className="container-grid-y7">
                ...
                <div style={{ margin: "18px auto" }}>
                  ...
                  <p className="section-title">$1,769.00</p>
                  <Button
                    variant="contained"
      ...
      <Box className="section-container">
        <Container maxWidth="md">
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <div className="section-image-container">
                <img className="section-image" src="/rectangle-48@2x.png" />
              </div>
            </Grid>
            <Grid item xs={12} md={6} container alignItems="center">
              <div className="container-grid-y7">
                ...
                <div style={{ margin: "18px auto" }}>
                  <p className="section-title">Starting at $2,656.00</p>
                  <Button
                    variant="contained"
                    className="section-grid-button"
          ...
          <Grid container>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-49@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-50@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-57@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-52@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-53@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-54@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-55@2x.png" />
                </div>
              </div>
            </Grid>
            <Grid item xs={12} md={3}>
              <div className="section-container-grid" style={{ width: "90%" }}>
                <div className="section-image-container">
                  <img className="section-image" src="/rectangle-56@2x.png" />
                </div>
              </div>
            </Grid>
          </Grid>
