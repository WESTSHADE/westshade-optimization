  ...
  return (
    <div>
      <Box
        ...
        style={{
          minHeight: "400px",
          backgroundImage: "url('/2000-700-1-1-5@1x.jpg')",
      ...
      >
        <Container maxWidth="md">
          <h3 className="section-title">
            Industry Leading Dependable Canopies & Umbrellas
          </h3>
          <p className="section-content-entend">
            Welcome to the #1 dependable canopy manufacturer in the U.S! We are
            your exclusive supplier of indoor and outdoor shelter, umbrellas,
            and different accessories to help make your experience more
            memorable. Talk to our team of experts today and we'll help you
            browse through our exclusive selection of canopies and umbrellas for
            your next event!
          </p>
        </Container>
      </Box>
      ...
      <Box className="section-container">
        <Container maxWidth="md">
          ...
          >
            <Grid item className="section-image-container">
              <img
                className="section-image"
                style={{ maxWidth: "120px", margin: "auto 48px" }}
                src="/professinal-quality.png"
              />
            </Grid>
            <Grid xs item>
