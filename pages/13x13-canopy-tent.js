...
function Canopy_Tent_Package({router}) {
    ...
    const handleSendQuote = async () => {
        if (!quoteSubject || !quoteNameLast || !quoteNameFirst || !quoteEmail || !quotePhone || !quoteRequest) {
            ...
            setShowModal(true);
            router.replace("/13x13-canopy-tent/#sent");
        }
    };
                        ...
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Typography color="textSecondary" paragraph={true}>
                                    Fit up to 20 people underneath our largest economical canopy for massive gatherings and events. Our 10x20 instant pop-up canopy tent provides up to 200 square feet of protection, big enough to host an
                                    outdoor picnic for 4
                                    families! If you are preparing for a trade show, hosting a party, commercial event, and other big occasions, this canopy tent is the one you are looking for! Choose between the Y5, Y6, and the Y7 series
                                    available today for
                                    the right activity. In addition, we offer customizable custom printing packages to make your marketing and original display shine in front of your audience!
                                </Typography>
                            </Container>
                        </CContainer>
                        <CContainer>
                                ...
                                <Grid container spacing={6}>
                                    ...
                                    <Grid item xs={12} md={6} container alignItems="center">
                                        <div className="position-r">
                                            ...
                                            <MXContainerBuy text={"$896.00"} backgroundColor={"#2767c5"} dot href={{pathname: "/y7-heavy-duty/buy"}}/>
                                        </div>
                                    </Grid>
                                </Grid>
                            </Container>
                        ...
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} md={6}>
                                        <MXImageDisplay src="/images/rectangle-48-1@2x.png"/>
                                    </Grid>
                                    <Grid item xs={12} md={6} container alignContent="center">
                                        ...
                                        <Typography variant="h6" display="block" color="textPrimary" paragraph={true}>
                                            <strong>Starting at $1,445.00</strong>
                                        </Typography>
                                        <div style={{display: "flex", justifyContent: "flex-start"}}>
                                            <Button variant="contained" className="section-grid-button" style={{marginRight: "24px"}} onClick={() => router.push("/custom-printed-package/f1313cpp")} disableElevation>
                                                Buy
                                            </Button>
                                            <Button variant="contained" className="section-grid-button" style={{marginRight: "24px"}}
                                                    onClick={() => {
                                                        setQuoteSubject("Y7 Heavy Duty Custom Print 13x13");
                            ...
                            <Container maxWidth="md">
                                <Grid container spacing={2} direction="row" alignItems="center">
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP1.jpg" alt="custom-printing-13x13-package-1"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP2.jpg" alt="custom-printing-13x13-package-2"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP3.jpg" alt="custom-printing-13x13-package-3"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP4.jpg" alt="custom-printing-13x13-package-4"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP5.jpg" alt="custom-printing-13x13-package-5"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP6.jpg" alt="custom-printing-13x13-package-6"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP7.jpg" alt="custom-printing-13x13-package-7"/>
                                        </div>
                                    </Grid>
                                    <Grid item xs={12} sm={6} md={3}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/13x13/Y7F1313CPP8.jpg" alt="custom-printing-13x13-package-8"/>
                                        </div>
                                    </Grid>
                                </Grid>
                            </Container>
