                        ...
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> Series Compare </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                            <Container maxWidth="md">
                                            ...
                                            <div>
                                                <div className="position-r">
                                                    <img
                                                        ...
                                                        src="/images/rectangle-40-1@2x.png"
                                                    />
                                                </div>
                                        ...
                                        >
                                            <div>
                                                <div className="position-r">
                                                    <img
                                                        className="section-image"
                                                        src="/images/rectangle-41-1@2x.png"
                                                    />
                                                </div>
                                        ...
                                        >
                                            <div>
                                                <div className="position-r">
                                                    <img
                                                        className="section-image"
                                                        src="/images/rectangle-42-6@2x.png"
                                                    />
                                                </div>
                                            ...
                                            <List>
                                                ...
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        ...
                                                        secondary={"Zinc coated steel"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Plastic parts"}
                                                        secondary={"Nylon"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Footplate"}
                                                        secondary={"Triangular zinc coated steel"}
                                                    />
                                                </ListItem>
                                            </List>
                                        </Grid>
                                            ...
                                            <List>
                                                ...
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Footplate"}
                                                        secondary={"4' x 4' zinc coated steel"}
                                                    />
                                                </ListItem>
                                            </List>
                                        </Grid>
                                            ...
                                            <List>
                                                ...
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        ...
                                                        secondary={"0.05 inches (1.2mm)"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Truss bar height"}
                                                        secondary={"25mm"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                        ...
                                        <Grid item xs={4}>
                                            <List>
                                                ...
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Truss bar structure"}
                                                        secondary={"Built-in reinforcing rib"}
                                                    />
                                                </ListItem>
                                            </List>
                                        </Grid>
                                            ...
                                            <List>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Fabric"}
                                                        secondary={"500D Polyester with PVC coating 320gsm"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                ...
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Roof connected wall"}
                                                        secondary={"2 inch (5cm) velcro"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Wall connector"}
                                                        secondary={"#8 resin zipper"}
                                                    />
                                                </ListItem>
                                                <ListItem className="section-canopy-tent-listItem">
                                                    <ListItemText
                                                        className="section-canopy-tent-listItem-content"
                                                        primary={"Roof tension"}
                                                        secondary={"Spring"}
                                                    />
                                                </ListItem>
                                            </List>
                                ...
                                <Box className="section-container" style={{textAlign: "center"}}>
                                    <p
                                        className="section-content-entend"
                                        style={{marginBottom: "30px"}}
                                    >
                                        Contact and follow us to get the latest pop up canopy news and
                                        special offers from Instant Promotion.
                                    </p>
                                    <SectionSocialGroup/>
                                </Box>
                            </Container>
