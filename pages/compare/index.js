      ...
      <Box className="section-navbar-container section-container-breadcrumb">
        <Container maxWidth="md">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Link color="inherit" href="/canopy-tent" onClick={handleClick}>
              Canopy Tent
            </Link>
            <Typography color="textPrimary">Series Compare</Typography>
          </Breadcrumbs>
        </Container>
      </Box>
