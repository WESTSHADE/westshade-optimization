						...
						<CContainer>
							<Container maxWidth="md">
								...
								<Typography color="textSecondary" paragraph={true}>
									Our professional team helps your canopy tents attract audiences by the unique design stands out at any trade shows, restaurants outdoor dining, job fairs, and many more! Each of our custom canopy is easy pop up design and
							...
							<Container maxWidth="md">
								...
								<Grid container alignItems="center">
									<Grid item xs={12} sm={6}>
										<CLink href="tel:949-751-1070" color="black" size="large" style={{ margin: "36px auto 24px", minWidth: 120, border: "1px solid black" }}>
											Call 949-751-1070
										</CLink>
									</Grid>
									<Grid item xs={12} sm={6}>
