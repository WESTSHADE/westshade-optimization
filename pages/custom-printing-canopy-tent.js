        ...
        <React.Fragment>
            <Head>
                ...
                <meta name="description"
                      content="Printing packages are based on your needs with a large selection of sizes and colors to promo your business, get free design today!"/>
            </Head>
                        ...
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> Canopy Tent </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                            <Container maxWidth="md">
                                <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}>
                                    View custom printed package gallery below to find the best fit plan
                                    quickly.
                                </Typography>
                                <Typography color="textSecondary" paragraph={true}>
                                    Our professional team helps your canopy tents attract audiences by
                                    the unique design stands out at any trade shows, restaurants outdoor
                                    dining, job fairs, and many more! Each of our custom canopy is easy
                                    pop up design and comes with a free rolling travel bag. Start with a
                                    free personalized print design from our professional designers, and
                                    promote your business and brand today!
                                </Typography>
                            </Container>
                        </CContainer>
                        <CContainer>
                            <Container maxWidth="md">
                                ...
                                <Grid container alignItems="center">
                                    <Grid item xs={12} sm={6}>
                                        <CLink href="tel:949-522-8111" color="black" size="large" style={{margin: "36px auto 24px", minWidth: 120, border: "1px solid black"}}>
                                            Call 949-522-8111
                                        </CLink>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <CLink href={{pathname: "/contact-us"}} color="black" size="large"
                                               style={{margin: "36px auto 24px", minWidth: 120, border: "1px solid black"}}>
                                            Email Us
                                        </CLink>
                                    </Grid>
                                </Grid>
                            ...
                            <Container maxWidth="md">
                                ...
                                <Grid container spacing={2} direction="row" alignItems="center">
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 10x10 ft </Typography>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 10x15 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 10x20 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 13X13 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 13X20 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 13X26 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 16X16 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}> 20X20 ft </Typography>
                                        <MXImageDisplay src="/images/custom-printing/custom-printing-function.jpeg" alt="custom-printing-function"/>
