            ...
            <Box className="page canopy-tent-package" fontSize={14} lineHeight={1.43}>
                {display ? (
                    <>
                        <CBreadcrumbs>
                            <Container maxWidth="md">
                                <Breadcrumbs classes={{li: "root-breadcrumbs-text"}}>
                                    ...
                                    <Typography variant="inherit" color="textPrimary"> 10x20 Canopy Tent </Typography>
                                </Breadcrumbs>
                            </Container>
                        </CBreadcrumbs>
                        <CContainer>
                                    ...
                                    <Grid item xs={12} md={4}>
                                        <div className="w-100p">
                                            <div className="position-r" style={{minHeight: 400}}>
                                                ...
                                                <Typography variant="subtitle2" color="inherit" style={{color: "#e59010"}} paragraph={true}> For recreational use </Typography>
                                    ...
                                    <Grid item xs={12} md={4}>
                                        <div className="w-100p">
                                            <div className="position-r" style={{minHeight: 400}}>
                                                ...
                                                <Typography variant="subtitle2" color="inherit" style={{color: "#e59010"}} paragraph={true}> For commercial use </Typography>
                                                <Typography variant='body2' color="textSecondary" paragraph={true}>
                                    ...
                                    <Grid item xs={12} md={4}>
                                        <div className="w-100p">
                                            <div className="position-r" style={{minHeight: 400}}>
                                                ...
                                                <Typography variant="subtitle2" color="inherit" style={{color: "#e59010"}} paragraph={true}> For heavy duty use </Typography>
                                                <Typography variant='body2' color="textSecondary" paragraph={true}>
                                            ...
                                            <List>
                                                ...
                                                <ListItem className="section-image-package-listItem-button">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            router.push({pathname: '/y5-economic/buy',})
                                                        }
                                                    >
                                                        Buy
                                                    </Button>
                        ...
                        <CContainer>
                            <Container maxWidth="md">
                                <Typography variant="h5" paragraph={true}> Custom printing </Typography>
                                <Grid container spacing={2} direction="row" alignItems="center">
                                    <Grid item xs={12} sm={4}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/10x20/F1020CPP4.jpg" alt="custom-printing-10x20-y5"/>
                                        </div>
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}><strong> Y5 Economic </strong></Typography>
                                        <Typography variant="subtitle2" color="textSecondary" paragraph={true}> Starting at $805 </Typography>
                                        <MXContainerBuy backgroundColor={"#2767c5"} href={{pathname: "/custom-printed-package/f1020cpp", query: {frame: "y5"}}}/>
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/10x20/F1020CPP8.jpg" alt="custom-printing-10x20-y6"/>
                                        </div>
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}><strong> Y6 Commercial </strong></Typography>
                                        <Typography variant="subtitle2" color="textSecondary" paragraph={true}> Starting at $965 </Typography>
                                        <MXContainerBuy backgroundColor={"#2767c5"} href={{pathname: "/custom-printed-package/f1020cpp", query: {frame: "y6"}}}/>
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
                                        <div className="position-r">
                                            <MXImageDisplay src="/images/product/custom-printed-package/10x20/F1020CPP7.jpg" alt="custom-printing-10x20-y7"/>
                                        </div>
                                        <Typography variant="subtitle1" classes={{subtitle1: "information-subtitle"}} paragraph={true}><strong> Y7 Heavy Duty </strong></Typography>
                                        <Typography variant="subtitle2" color="textSecondary" paragraph={true}> Starting at $1,365 </Typography>
                                        <MXContainerBuy backgroundColor={"#2767c5"} href={{pathname: "/custom-printed-package/f1020cpp", query: {frame: "y7"}}}/>
                                    </Grid>
                                </Grid>
                            </Container>
                        </CContainer>
